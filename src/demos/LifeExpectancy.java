 ...
 * <p>
 * It loads the country shapes from a GeoJSON file via a data reader, and loads the population density values from another CSV
 * file (provided by the World Bank). The data value is encoded to transparency via a simplistic linear mapping.
 */
    ...
    private void shadeCountries() {
        for (Marker marker : countryMarkers) {
            ...
            if (lifeExpMap.containsKey(countryId)) {
                ...
                marker.setColor(color(20 - colorLevel, 100, colorLevel));
            }
            else {
